...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2023 at 08:50 AM
...
INSERT INTO `cover` (`coverCode`, `name`, `image`, `description`, `createAt`, `updateAt`, `deleteAt`) VALUES
(1, 'Lutung Kasarung', '8cab3774f97714e2ff3bbfb3b10f8c9d-6410b25949dc2.jpg', 'asdasdsad asdasdas dasd asd asd asdas d asd asd asd sa', '2023-03-15 00:40:04', '2023-03-15 00:43:53', NULL);
...
(6, 'Home', '2023-03-15 00:24:37', NULL, NULL),
(7, 'Vision', '2023-03-15 00:24:37', NULL, NULL),
(8, 'Article', '2023-03-15 00:24:37', NULL, NULL),
(9, 'Structure', '2023-03-15 00:24:37', NULL, NULL),
(10, 'Profile Office', '2023-03-15 00:24:37', NULL, NULL),
(11, 'Information Lobby', '2023-03-15 00:24:37', NULL, NULL);
...
(29, 'RHOME', 'See home', 6, '2023-03-15 00:24:37', NULL, NULL),
(30, 'UHOME', 'Update home', 6, '2023-03-15 00:24:37', NULL, NULL),
(31, 'RVISION', 'See vision', 7, '2023-03-15 00:24:37', NULL, NULL),
(32, 'UVISION', 'Update vision', 7, '2023-03-15 00:24:37', NULL, NULL),
(33, 'RARTICLE', 'See article', 8, '2023-03-15 00:24:37', NULL, NULL),
(34, 'CARTICLE', 'Create article', 8, '2023-03-15 00:24:37', NULL, NULL),
(35, 'UARTICLE', 'Update article', 8, '2023-03-15 00:24:37', NULL, NULL),
(36, 'DARTICLE', 'Delete article', 8, '2023-03-15 00:24:37', NULL, NULL),
(37, 'RSTRUCTURE', 'See structure', 9, '2023-03-15 00:24:37', NULL, NULL),
(38, 'CSTRUCTURE', 'Create structure', 9, '2023-03-15 00:24:37', NULL, NULL),
(39, 'USTRUCTURE', 'Update structure', 9, '2023-03-15 00:24:37', NULL, NULL),
(40, 'DSTRUCTURE', 'Delete structure', 9, '2023-03-15 00:24:37', NULL, NULL),
(41, 'RPO', 'See profile office', 10, '2023-03-15 00:24:37', NULL, NULL),
(42, 'CPO', 'Create profile office', 10, '2023-03-15 00:24:37', NULL, NULL),
(43, 'UPO', 'Update profile office', 10, '2023-03-15 00:24:37', NULL, NULL),
(44, 'DPO', 'Delete profile office', 10, '2023-03-15 00:24:37', NULL, NULL),
(45, 'RINFORMATIONLOBBY', 'See information lobby', 11, '2023-03-15 00:24:37', NULL, NULL),
(46, 'CINFORMATIONLOBBY', 'Create information lobby', 11, '2023-03-15 00:24:37', NULL, NULL),
(47, 'UINFORMATIONLOBBY', 'Update information lobby', 11, '2023-03-15 00:24:37', NULL, NULL),
(48, 'DINFORMATIONLOBBY', 'Delete information lobby', 11, '2023-03-15 00:24:37', NULL, NULL);
...
(31, 29, 1, '2023-03-15 00:24:37', NULL, NULL),
(32, 30, 1, '2023-03-15 00:24:37', NULL, NULL),
(33, 31, 1, '2023-03-15 00:24:37', NULL, NULL),
(34, 32, 1, '2023-03-15 00:24:37', NULL, NULL),
(35, 33, 1, '2023-03-15 00:24:37', NULL, NULL),
(36, 34, 1, '2023-03-15 00:24:37', NULL, NULL),
(37, 35, 1, '2023-03-15 00:24:37', NULL, NULL),
(38, 36, 1, '2023-03-15 00:24:37', NULL, NULL),
(39, 37, 1, '2023-03-15 00:24:37', NULL, NULL),
(40, 38, 1, '2023-03-15 00:24:37', NULL, NULL),
(41, 39, 1, '2023-03-15 00:24:37', NULL, NULL),
(42, 40, 1, '2023-03-15 00:24:37', NULL, NULL),
(43, 41, 1, '2023-03-15 00:24:37', NULL, NULL),
(44, 42, 1, '2023-03-15 00:24:37', NULL, NULL),
(45, 43, 1, '2023-03-15 00:24:37', NULL, NULL),
(46, 44, 1, '2023-03-15 00:24:37', NULL, NULL),
(47, 45, 1, '2023-03-15 00:24:37', NULL, NULL),
(48, 46, 1, '2023-03-15 00:24:37', NULL, NULL),
(49, 47, 1, '2023-03-15 00:24:37', NULL, NULL),
(50, 48, 1, '2023-03-15 00:24:37', NULL, NULL);
...
--
-- Table structure for table `scientific`
--

CREATE TABLE `scientific` (
  `scientificCode` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `image` varchar(255) NOT NULL,
  `description` longtext NOT NULL,
  `createAt` datetime NOT NULL DEFAULT current_timestamp(),
...
('::1', '2023-03-15', 13, '1678814311', '2023-03-15 00:08:04');
...
--
ALTER TABLE `cover`
  ADD PRIMARY KEY (`coverCode`) USING BTREE;
...
--
-- Indexes for table `scientific`
--
ALTER TABLE `scientific`
  ADD PRIMARY KEY (`scientificCode`) USING BTREE;
...
--
ALTER TABLE `cover`
  MODIFY `coverCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `module`
  MODIFY `moduleCode` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `permission`
--
ALTER TABLE `permission`
  MODIFY `permissionCode` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `role_permission`
  MODIFY `rpCode` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
-- AUTO_INCREMENT for table `scientific`
--
ALTER TABLE `scientific`
  MODIFY `scientificCode` int(11) NOT NULL AUTO_INCREMENT;
