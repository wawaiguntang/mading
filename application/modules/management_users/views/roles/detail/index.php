            ...
            <div class="row mt-4">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-borderless">
                        ...
                        <tr>
                            <td class="p-1 fw-bold d-flex">Permission <?php echo ((in_array('CRP', $userPermission)) ? '<a href="'.base_url('management_users/roles/addPermission/'.$roleCode).'" class="a-spa"><i class="ri-add-circle-line ri-lg text-success my-auto" role="button" title="Add Permission" ></i></a>' : '') ?></td>
                            <td class="p-1">:</td>
...
<script>
    function deletePermission(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: base_url + 'management_users/action/roles/deletePermission/' + id,
                    type: "POST",
