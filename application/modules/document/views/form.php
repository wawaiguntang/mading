    ...
    <div class="col-md-8 offset-md-2">
        <div class="card mb-4">
            <div class="card-body  px-4 pt-2 pb-2">
                ...
                <?php echo input('hidden', 'documentCode', '', [], ["value" => $documentCode]); ?>
                <?php echo inputWithFormGroup('Nama', 'text', 'name', 'Nama', [], ["value" => $name]); ?>
                <?php echo inputWithFormGroup('URL', 'text', 'slug', 'URL', [], ["value" => $slug]); ?>
                <?php echo inputWithFormGroup('PDF', 'file', 'file', 'PDF', []); ?>
                <?php echo selectWithFormGroup('documentParent', 'Rujukan', 'documentParent', $parent, $documentParent, []) ?>
...
<script>
    function saveDataD() {
        ...
        <?php if ($documentCode) : ?>
            url = base_url + 'document/action/index/update/' + <?php echo $documentCode ?>;
        <?php else : ?>
            url = base_url + 'document/action/index/add';
        <?php endif ?>
