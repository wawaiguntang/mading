...
class Scientific_model extends CI_Model
{

	var $table = 'scientific';
	...
	var $order = array('scientificCode' => 'desc'); // default order 
	...
	{
		$this->db->from($this->table);
		$this->db->where('scientificCode', $id)->where('deleteAt',NULL);
		$query = $this->db->get();
	...
	public function delete_by_id($id)
	{
		...
		$this->db->update($this->table, $data, ['scientificCode' => $id]);
		return $this->db->affected_rows();
	}
}