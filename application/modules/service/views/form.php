    ...
    <div class="col-md-8 offset-md-2">
        <div class="card mb-4">
            <div class="card-body  px-4 pt-2 pb-2">
                ...
                <?php echo input('hidden', 'serviceCode', '', [], ["value" => $serviceCode]); ?>
                <?php echo inputWithFormGroup('Nama', 'text', 'name', 'Nama', [], ["value" => $name]); ?>
                <?php echo inputWithFormGroup('URL', 'text', 'url', 'URL', [], ["value" => $url]); ?>
...
<script>
    function saveDataD() {
        ...
        <?php if ($serviceCode) : ?>
            url = base_url + 'service/action/index/update/' + <?php echo $serviceCode ?>;
        <?php else : ?>
            url = base_url + 'service/action/index/add';
        <?php endif ?>
