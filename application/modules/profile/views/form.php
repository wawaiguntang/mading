    ...
    <div class="col-md-8 offset-md-2">
        <div class="card mb-4">
            <div class="card-body  px-4 pt-2 pb-2">
                ...
                <?php echo input('hidden', 'poCode', '', [], ["value" => $poCode]); ?>
                <?php echo inputWithFormGroup('Nama', 'text', 'name', 'Nama', [], ["value" => $name]); ?>
                <?php echo inputWithFormGroup('Title', 'text', 'title', 'Title', [], ["value" => $title]); ?>
                <?php echo inputWithFormGroup('Facebook', 'text', 'fb', 'Facebook', [], ["value" => $fb]); ?>
                <?php echo inputWithFormGroup('Instagram', 'text', 'ig', 'Instagram', [], ["value" => $ig]); ?>
                <?php echo inputWithFormGroup('Twitter', 'text', 'tw', 'Twitter', [], ["value" => $tw]); ?>
                <?php echo inputWithFormGroup('Youtube', 'text', 'yt', 'Youtube', [], ["value" => $yt]); ?>
...
<script>
    function saveDataD() {
        ...
        <?php if ($poCode) : ?>
            url = base_url + 'profile/action/index/update/' + <?php echo $poCode ?>;
        <?php else : ?>
            url = base_url + 'profile/action/index/add';
        <?php endif ?>
